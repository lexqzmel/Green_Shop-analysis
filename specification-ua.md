...
* [Блок 2: Системний аналіз та дизайн (System Analysis and Design)](#блок-2-системний-аналіз-та-дизайн-system-analysis-and-design)
  ...
  * [4. Нефункциональні вимоги (Non-Functional Requirements – NFR)](#4-нефункциональні-вимоги-non-functional-requirements--nfr)
  * [5. Модель даних (ERD) та Архітектура бази даних](#5-модель-даних-erd-та-архітектура-бази-данних)
