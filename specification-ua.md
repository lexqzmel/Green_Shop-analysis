...
* **[Інтерактивний прототип](https://www.figma.com/design/M6TdfaBpb7u0eTTQ6W4zFF/PlantStore?node-id=01&t=00kjkQDIeDVouZMJ-1)**
...
![ERD Модель бази даних MySQL](./green_shop_db/green_shop_db.png)
...
* **[Протестувати Live API Mock Server та Postman-документацію](https://documenter.getpostman.com/view/17765106/2sBYAuSBAz)** - публічна колекція Green Shop API для симуляції відповідей сервера.
 
Створено колекцію **Green Shop API**, яка повністю описує REST API для інтернет-магазину кімнатних рослин та аксесуарів. Проєкт спроєктовано з урахуванням сучасних стандартів безпеки, обробки помилок та інтеграції з популярними сторонніми сервісами (Stripe, логістичні оператори).
